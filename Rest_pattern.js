...
//Spread Operator can be written generally on the right side of the = operator like this.

const arr = [1, 2, ...[3, 4]];

//While rest pattern can be written generally on the left side of the = operator like this.
//Notation of rest pattern and spread operator is both same but rest pattern actually works in
//opposite way. Opposite way in the sense that it actually bundle up all the array elements into
//new array.
...
//Rest pattern can also be used in objects which is commonly called as rest parameter.
//Objects
